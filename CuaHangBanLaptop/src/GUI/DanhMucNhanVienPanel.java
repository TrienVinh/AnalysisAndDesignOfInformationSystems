...
import BUS.DanhMucNhanVienController;

public class DanhMucNhanVienPanel extends JPanel {
	...
	public DanhMucNhanVienPanel() {
		...
		JLabel lblKhachHang = new JLabel("Quản Lý Nhân Viên");
						...
						.addGroup(gl_panel_1.createSequentialGroup()
							.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_1.createSequentialGroup()
									...
									.addGap(18)
									.addComponent(jtfMa, GroupLayout.DEFAULT_SIZE, 166, Short.MAX_VALUE))
								.addGroup(gl_panel_1.createSequentialGroup()
									.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
										.addComponent(lblGiiTnh, GroupLayout.PREFERRED_SIZE, 115, GroupLayout.PREFERRED_SIZE)
										.addComponent(lblNgySinh, GroupLayout.PREFERRED_SIZE, 115, GroupLayout.PREFERRED_SIZE))
									.addGap(33)
									.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panel_1.createSequentialGroup()
											.addComponent(jrbNam, GroupLayout.PREFERRED_SIZE, 69, GroupLayout.PREFERRED_SIZE)
											.addGap(4)
											.addComponent(jrbNu, GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE))
										.addComponent(jdcNgaySinh, GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE))))
							.addGap(52)
							.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_1.createSequentialGroup()
									.addComponent(lblaCh, GroupLayout.PREFERRED_SIZE, 74, GroupLayout.PREFERRED_SIZE)
									.addGap(26)
									.addComponent(jtfDiaChi, GroupLayout.DEFAULT_SIZE, 550, Short.MAX_VALUE))
								.addGroup(gl_panel_1.createSequentialGroup()
									.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panel_1.createSequentialGroup()
											.addComponent(lblEmail, GroupLayout.PREFERRED_SIZE, 61, GroupLayout.PREFERRED_SIZE)
											.addGap(39)
											.addComponent(jtfEmail, GroupLayout.DEFAULT_SIZE, 199, Short.MAX_VALUE))
										.addGroup(gl_panel_1.createSequentialGroup()
											.addComponent(lblH, GroupLayout.PREFERRED_SIZE, 61, GroupLayout.PREFERRED_SIZE)
											.addGap(39)
											.addComponent(jtfHo, GroupLayout.DEFAULT_SIZE, 199, Short.MAX_VALUE)))
									.addGap(72)
									.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panel_1.createSequentialGroup()
											.addComponent(lblTn, GroupLayout.PREFERRED_SIZE, 61, GroupLayout.PREFERRED_SIZE)
											.addGap(18)
											.addComponent(jtfTen, GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE))
										.addGroup(gl_panel_1.createSequentialGroup()
											.addComponent(lblSdt, GroupLayout.PREFERRED_SIZE, 61, GroupLayout.PREFERRED_SIZE)
											.addGap(18)
											.addComponent(jtfSDT, GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)))))))
					.addGap(59))
		);
			...
			gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup()
					...
					.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel_1.createSequentialGroup()
							.addGap(1)
							.addComponent(jtfHo, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel_1.createSequentialGroup()
							.addGap(2)
							.addComponent(lblTn))
						.addGroup(gl_panel_1.createSequentialGroup()
						...
						.addComponent(jtfMa, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_1.createSequentialGroup()
							.addGap(8)
							.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panel_1.createSequentialGroup()
									.addGap(3)
									.addComponent(jrbNam, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE))
								.addComponent(lblEmail)))
						.addGroup(gl_panel_1.createSequentialGroup()
							.addGap(11)
							.addComponent(jrbNu, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel_1.createSequentialGroup()
							.addGap(9)
							.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_1.createSequentialGroup()
									.addGap(1)
									.addComponent(lblSdt, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE))
					...
					.addGap(8)
					.addComponent(lblMsg, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE)
					.addGap(14)
					.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE)
							.addComponent(jbtnTimKiem, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)
							.addComponent(jbtnLamMoi, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE))))
		);
		panel_1.setLayout(gl_panel_1);
		panel.setLayout(gl_panel);
		setLayout(groupLayout);

		DanhMucNhanVienController control = new DanhMucNhanVienController(jtfMa, jtfHo, jtfTen, jtfDiaChi, jtfEmail,
